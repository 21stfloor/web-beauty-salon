<nav class="sb-topnav navbar navbar-expand navbar-dark bg-primary">
    <a class="navbar-brand ps-3" href="{{ route('home') }}">
        <img src="{{ asset('images/logo-light.png') }}" alt="logo" height="32"> Smile Pro HQ</a>
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                ...
                @if (Auth::user()->hasRole('admin'))
                    <li><a class="dropdown-item" href="{{ route('admins.profile') }}">Profile</a></li>
                @elseif (Auth::user()->hasRole('doctor'))
                    <li><a class="dropdown-item" href="{{ route('doctors.profile') }}">Profile</a></li>
                @elseif (Auth::user()->hasRole('patient'))
                    <li><a class="dropdown-item" href="{{ route('patients.profile') }}">Profile</a></li>
                @endif
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5 text-primary" id="logoutModalLabel">Confirm Logout</h1>

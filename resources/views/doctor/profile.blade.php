    ...
    <div class="row mb-3">
        <div class="col-lg-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <h4 class="small fw-bold">Ongoing<span class="float-end">40%</span></h4>
                    ...
                    <h4 class="small fw-bold">Completed<span class="float-end">80%</span></h4>
                    <div class="progress progress-sm mb-3">
                        <div class="progress-bar bg-success" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"
                            style="width: 80%;"><span class="visually-hidden">80%</span></div>
                    </div>
                    <h4 class="small fw-bold">Rejected<span class="float-end">20%</span></h4>
                    <div class="progress progress-sm mb-3">
